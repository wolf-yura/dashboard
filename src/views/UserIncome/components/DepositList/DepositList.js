...
const DepositList = props => {
  ...
  const { className, DepositService, AuthService, ...rest } = props;
  //handle table
  ...
  useEffect(() => {
    const fetchUsers = async () => {
      try {
        ...
        const response = await DepositService.get_deposit({user_id: AuthService.getCurrentUser().id, status: 'concluído' });
